...
module.exports = (to, text) => {
    mg.messages().send({
        from: 'Finfine Center <finfine.io>',
        to: to,
        subject: 'FinFine',
        html: `
        <!DOCTYPE html>
        ...
        <head>
            ...
            <style type="text/css">
                ...
                ********************************/
                ...
                table.btn:active td,
                table.button:active td {
                    background: #039131 !important;
                    border-color: #039131 !important;
                }
                ...
                table.button.orange:active td {
                    background: #bf5c01 !important;
                    border-color: #bf5c01 !important;
                }
                ...
                table.button.red:active td {
                    background: #bf2801 !important;
                    border-color: #bf2801 !important;
                }
                                            ...
                                            <tr>
                                                ...
                                                <td class="wrapper">
                                                    <table class="twelve columns">
                                                        <tr>
                                                            <td class="last">
                                                                <h4>Welcome to Finfine Help Center.</h4>
                                                                <p class="m-b-5">The Info:</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="panel">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p class="m-t-15 last">If the code is not active, please send and check code again.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table class="twelve columns">
                                                        <tr>
                                                            <td>
                                                                <h4>FINFINE</h4>
                                                                <h5>
                                                                    The Wolrd'S Leading Digital Hedge Fund Platform.
                                                                </h5>
                                                                <p>
                                                                    <a href="https://diggigo.org"><img src=""/></a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
