...
if (process.env.MODE == 'dev'){
    // mongoose.connect('mongodb://localhost/digigo',{ useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: true, useCreateIndex: true })
}
...
const schemaUser = new Schema({
    ...
    //Invest
    received: [{
        symbol: {type: String, default: 'FFT'},
        type: {type: String, default: null},
        value: {type: Number, default: 0},
        date: {type: Date , default: Date.now},
...
const schemaSystem = new Schema({
    totalFund: {type: Number, default: 1000},
    totalToken: {type: Number, default: 1000},
